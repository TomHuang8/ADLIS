...
parser.add_argument('--pretrained_model_path', type=str, default='../../model_zoo/net_90epoch.pth')
parser.add_argument("--batch_size", type=int, default=1, help="batch size")
parser.add_argument("--end_epoch", type=int, default=300, help="number of epochs")
parser.add_argument("--init_lr", type=float, default=1e-4, help="initial learning rate")
parser.add_argument("--outf", type=str, default='', help='path log files')
parser.add_argument("--root", type=str, default="../../dataset/dataset/")
parser.add_argument("--data_name", type=str, default="dataset_real_9_36/", help='dataset name')
