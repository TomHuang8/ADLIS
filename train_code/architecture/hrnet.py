...
# ----------------------------------------
class SGN(nn.Module):
    def __init__(self, in_channels=3 * opt.frame, out_channels=opt.num_pixels * opt.num_wavelengths, start_channels=opt.hrnetchannels, pad='zero', activ='lrelu', norm='none', ):
